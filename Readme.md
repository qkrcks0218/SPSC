...
* 0.Analysis_OverlapSelection.R, 0.Analysis_LassoSelection.R, and 0.Analysis_RegressionSelection.R provide details on how donors are selected. 

* 0.Function_SPSC_Data.R contains functions used for the data analysis.

* 1-1.ATT_SPSC.R and 1-2.ATT_Time_SPSC.R estimate the ATT using the SPSC approach with time-invariant $`g`$ and time-varying $`g_t`$, respectively.

* 1-3.ATT_Abadie.R estimates the ATT using the approach of [Abadie et al. (2010)](https://www.tandfonline.com/doi/abs/10.1198/jasa.2009.ap08746 "Abadie").

* 1-4.ATT_Placebo_SPSC.R estimates the placebo ATT using the SPSC approach.

* 2-1.Conformal_SPSC.R and 2-2.Conformal_Time_SPSC.R estimate prediction intervals of the ATT using the conformal inference approach of [Chernozhukov et al. (2021)](https://www.tandfonline.com/doi/abs/10.1080/01621459.2021.1920957, "Conformal") adapted to the SPSC setting.

* 2-3.Conformal_SCPI.R estimates prediction intervals of the ATT using the approach of [Cattaneo et al. (2021)](https://www.tandfonline.com/doi/full/10.1080/01621459.2021.1979561, "SCPI")

* 2-4.Conformal_Placebo_SPSC.R estimates prediction intervals of the placebo ATT using the conformal inference approach of [Chernozhukov et al. (2021)](https://www.tandfonline.com/doi/abs/10.1080/01621459.2021.1920957, "Conformal") adapted to the SPSC setting.

* 3-1.Table_ATT.R, 3-2.Plot_Conformal.R, and 3-3.Table_Plot_Placebo.R summarize the results into tables and figures of the paper and supplementary material.
