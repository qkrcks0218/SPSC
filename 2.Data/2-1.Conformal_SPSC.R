...
write.csv(CP.CI,    sprintf("Conformal_Raw/Raw_Group%s_CPCI_%0.3d.csv",           gp,ITER),row.names=F)
write.csv(CP.Beta.1,sprintf("Conformal_Raw/Raw_Group%s_CPBeta_SPSC_%0.3d.csv",    gp,ITER),row.names=F)
write.csv(CP.Beta.2,sprintf("Conformal_Raw/Raw_Group%s_CPBeta_SPSC_Reg_%0.3d.csv",gp,ITER),row.names=F)
write.csv(CP.PV.1,  sprintf("Conformal_Raw/Raw_Group%s_CPPV_SPSC_%0.3d.csv",      gp,ITER),row.names=F)
write.csv(CP.PV.2,  sprintf("Conformal_Raw/Raw_Group%s_CPPV_SPSC_Reg_%0.3d.csv",  gp,ITER),row.names=F)
